...
{
    [Serializable]
    public class SerializedObservableList <T> : IList<T>, IList, INotifyCollectionChanged, INotifyPropertyChanged, ISerializationCallbackReceiver
    {
        ...
        [SerializeField, HideInInspector] private List<T> _data = new List<T>();
        ...
        public SerializedObservableList ()
        {
            items = new List<T>();
        }

        public SerializedObservableList (List<T> list)
        {
            if (list == null)
