...
{
    [Serializable]
    public class SerializedObservableDictionary<TKey, TValue> : IDictionary<TKey, TValue>, IDictionary, INotifyCollectionChanged, INotifyPropertyChanged, ISerializationCallbackReceiver
    {
        ...
        public SerializedObservableDictionary()
        {
            this.dictionary = new Dictionary<TKey, TValue>();
        }
        public SerializedObservableDictionary(IDictionary<TKey, TValue> dictionary)
        {
            this.dictionary = new Dictionary<TKey, TValue>(dictionary);
        }
        public SerializedObservableDictionary(IEqualityComparer<TKey> comparer)
        {
            this.dictionary = new Dictionary<TKey, TValue>(comparer);
        }
        public SerializedObservableDictionary(int capacity)
        {
            this.dictionary = new Dictionary<TKey, TValue>(capacity);
        }
        public SerializedObservableDictionary(IDictionary<TKey, TValue> dictionary, IEqualityComparer<TKey> comparer)
        {
            this.dictionary = new Dictionary<TKey, TValue>(dictionary, comparer);
        }
        public SerializedObservableDictionary(int capacity, IEqualityComparer<TKey> comparer)
        {
